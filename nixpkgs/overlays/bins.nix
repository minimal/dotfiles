        ...
        let
          sources = {
            ...
            "x86_64-linux" = fetchzip {
              url = "https://github.com/babashka/babashka/releases/download/v0.4.6/babashka-0.4.6-linux-amd64.tar.gz";
              sha256 = "12wif13q43hk441j35nbb9nn4k26x40lhgqkc1mamwcnl30bilaj";
              name = "babashka";
            };
          };
        in
